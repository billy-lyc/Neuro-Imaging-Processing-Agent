...
export default function FreeBrowse() {
  ...
  const originalVolumeRef = useRef<NVImage | null>(null);
  ...
  const {
    ...
    handleConfirmRemove,
    handleCancelRemove,
  } = useVolumes(nvRef, debouncedGLUpdate, removeSurface, originalVolumeRef);
  const {
  ...
  } = useDrawing(nvRef, debouncedGLUpdate, originalVolumeRef);
  const {
    handleSaveScene,
    handleConfirmSave,
    handleCancelSave,
    ...
    <ViewerShell
      ...
      sidebar={
        <Sidebar
          ...
          onSurfaceFileSelect={handleSurfaceFileSelect}
          ...
          onEditIntentChange={handleEditIntentChange}
          onReconModeChange={handleReconModeChange}
          onReconTargetChange={handleReconTargetChange}
          onDiscardDrawing={handleDiscardDrawing}
